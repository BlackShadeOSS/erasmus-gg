...
export default function pamiec() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-10">
      ...
      <h1 className="text-4xl font-bold text-green-300 mb-10 mt-16">Pamięć</h1>
      <main id="gameSetUp" className="md:text-base text-2xl">
        ...
        <p className="2xl:mx-80 sm:mx-36 mx-10 ">
          Kliknij kartę aby ją odsłonić. Odkryj drugą kartę, jeśli pasują
          (słówko po angielsku do słówka po polsku) karty znikają z pola. Jeśli
          nie pasują, zapamiętaj ich pozycję i ich zawartość. Karty zostaną
          ponownie zakryte i możesz próbować dalej. Gra kończy się gdy pole
          zostanie oczyszczone z kart lub gdy wszystkie próby zostaną
          wykorzystane.
        </p>
      </main>

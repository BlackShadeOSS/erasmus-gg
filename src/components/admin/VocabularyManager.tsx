...
export default function VocabularyManager() {
  ...
  const fetchVocabulary = useCallback(
    async (forceRefresh = false) => {
      ...
      try {
        ...
        const fetchPromise = fetch(`/api/admin/vocabulary?${urlParams}`, {
  ...
  const handleDelete = async (entry: VocabularyEntry) => {
    try {
      const response = await fetch(`/api/admin/vocabulary?id=${entry.id}`, {
        method: "DELETE",
      });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-4 items-end">
              ...
              >
                ...
                {categories
                  .filter(
                    (category) =>
                      !selectedProfession ||
                      category.profession_id === selectedProfession
                  )
                  .map((category) => (
        ...
        <Button
          onClick={
            activeTab === "vocabulary" ? openAddModal : openAddCategoryModal
          }
        >
          {activeTab === "vocabulary" ? "Dodaj słownictwo" : "Dodaj kategorię"}
        </Button>
      </div>

      {/* Table */}
      {loading ? (
        <div className="text-center py-8 text-neutral-400">Ładowanie...</div>
      ) : activeTab === "vocabulary" ? (
        vocabulary.length === 0 ? (
            ...
            <TableBody>
              {vocabulary.map((entry) => (
                <TableRow key={entry.id}>
                  <TableCell>
                    <div className="font-medium">{entry.term_en}</div>
                    {entry.pronunciation && (
                  ...
                  <TableCell className="font-medium">{entry.term_pl}</TableCell>
                  <TableCell>
              ...
              <TableRow key={category.id}>
                ...
                <TableCell>
                  <span className="px-2 py-1 bg-green-200 text-neutral-900 rounded text-xs">
                    {category._count?.vocabulary || 0} wpisów
                  </span>
                </TableCell>
                <TableCell className="text-neutral-400">
        ...
        {activeTab === "vocabulary" ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="term_en">Termin (angielski) *</Label>
                <Input
                  id="term_en"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="definition_en">Definicja (angielska)</Label>
                <Textarea
                  id="definition_en"
              ...
              <div>
                <Label htmlFor="definition_pl">Definicja (polska)</Label>
                <Textarea
                  id="definition_pl"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="example_sentence_pl">Przykład (polski)</Label>
                <Textarea
            ...
            <div>
              <Label htmlFor="difficulty_level">Poziom trudności</Label>
              <Select
                id="difficulty_level"
          ...
          <form onSubmit={handleCategorySubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="category_name">Nazwa (polska) *</Label>
                <Input
                  id="category_name"
              ...
              <div>
                <Label htmlFor="category_name_en">Nazwa (angielska) *</Label>
                <Input
                  id="category_name_en"
        ...
        message={
          deleteConfirm.entry
            ...
            ? `Czy na pewno chcesz usunąć kategorię "${
                deleteConfirm.category?.name || "Unknown"
              }"? Ta akcja jest nieodwracalna i usunie również wszystkie wpisy słownictwa w tej kategorii.`
            : ""
        }
        confirmText="Usuń"
        cancelText="Anuluj"
